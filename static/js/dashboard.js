(function($) {
  ...
  $(function() {
    ...
    if ($("#sales-status-chart").length) {
      ...
      var meeting_list = $(".meeting_list").text().split(',');
      var attended = parseInt(meeting_list[0]);
      var missed = parseInt(meeting_list[1]);
    ...
    if ($("#daily-sales-chart").length) {
      var meeting_list = $(".meeting_list").text().split(',');
      var attended = parseInt(meeting_list[0]);
    var missed = parseInt(taskList[1]);
